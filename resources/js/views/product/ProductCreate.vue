            ...
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    <div class="page-title-icon">
                        <i class="fa fa-box icon-gradient bg-mean-fruit"></i>
                    </div>
                    <div>
                        Nuevo Producto
        ...
        <form @submit.prevent="submit">
            <div class="form-grid">
                ...
                <div class="form-section">
                    <div class="section-card">
                        <div class="section-header">
                            <i class="fa fa-dollar-sign section-icon icon-green"></i>
                            <span>Precio y opciones</span>
                        </div>
                        <div class="section-body">
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <div class="input-with-prefix">
                                        ...
                                        <input v-model="form.price" type="number" step="0.01" min="0"
                                            class="form-input" :class="{ 'has-error': errors.price }" />
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input v-model="form.comment" type="text" class="form-input"
                                    placeholder="Ej: Oferta limitada, Nuevo..." maxlength="120" />
                                <span class="help-text">Se muestra junto al producto (max 120 caracteres)</span>
                            </div>
            ...
            <div v-if="cropperOpen" class="cropper-modal-overlay" @click.self="cancelCrop">
                <div class="cropper-modal-container">
                    <div class="cropper-modal-header">
                        <h4>Recortar imagen del producto</h4>
