        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                ...
                <div class="page-title-actions">
                    <router-link :to="{ name: 'equipment.index' }" class="btn-action btn-back">
            ...
            <div class="form-grid">
                ...
                <div class="form-section">
                    ...
                    <div class="form-actions">
                        <router-link :to="{ name: 'equipment.index' }" class="btn-cancel">
                            Cancelar
                        </router-link>
...
export default {
    ...
    methods: {
        ...
        async submit() {
            ...
            try {
                const { data } = await equipmentService.store(payload);
                this.$router.push({ name: 'equipment.show', params: { id: data.id } });
            } catch (err) {
                if (err.response?.status === 422) {
                    this.errors = err.response.data.errors;
                } else {
                    this.generalError = err.response?.data?.message || 'Error al crear el equipo.';
                }
            } finally {
                this.loading = false;
            }
