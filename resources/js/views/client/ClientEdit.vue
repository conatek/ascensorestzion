            ...
            <div class="app-page-title">
                <div class="page-title-wrapper">
                    ...
                    <div class="page-title-actions">
                        <router-link :to="{ name: 'clients.show', params: { id: $route.params.id } }" class="btn-action btn-back">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-actions">
                            <router-link :to="{ name: 'clients.show', params: { id: $route.params.id } }" class="btn-cancel">
                                Cancelar
                            </router-link>
...
export default {
    ...
    async created() {
        ...
        const emails = Array.isArray(data.notification_emails) ? data.notification_emails : [];
        this.form = {
            ...
            notification_emails: emails.length ? [...emails] : [''],
    ...
    methods: {
        ...
        async submit() {
            ...
            try {
                await clientService.update(this.$route.params.id, payload);
                this.$router.push({ name: 'clients.show', params: { id: this.$route.params.id } });
            } catch (err) {
